...
export class Init1708590224878 implements MigrationInterface {
    name = 'Init1708590224878'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "board" ("id" SERIAL NOT NULL, "name" character varying(63) NOT NULL, "description" character varying(255), "teamId" integer, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "authorId" uuid NOT NULL, CONSTRAINT "PK_865a0f2e22c140d261b1df80eb1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "task" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(63) NOT NULL, "description" character varying, "deadline" TIMESTAMP WITH TIME ZONE, "isHighPriority" boolean NOT NULL DEFAULT false, "authorId" uuid NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "boardId" integer NOT NULL, "isCompleted" boolean NOT NULL DEFAULT false, "completedByUserId" uuid, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_f22209cec92fe85b6e2798c689c" FOREIGN KEY ("completedByUserId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "task" DROP CONSTRAINT "FK_f22209cec92fe85b6e2798c689c"`);
